...
Matrix GUI — учебный C++ проект для работы с матрицами. Программа позволяет вычислять определитель квадратной матрицы, решать системы линейных алгебраических уравнений и работать как через консоль, так и через графический интерфейс на Qt.
